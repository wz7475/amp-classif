Code for running predictions with AMPScanner2 is based on the implementation kindly provided by Daniel Veltri; it uses the latest release of the model (02.2020).
